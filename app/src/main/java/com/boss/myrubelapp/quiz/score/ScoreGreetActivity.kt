...
import kotlinx.android.synthetic.main.activity_score_greet.*

class ScoreGreetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_score_greet)

        supportActionBar?.title="Quiz Greetings"

        getNilai()
    }

    private fun getNilai() {
        val ref = FirebaseDatabase.getInstance().getReference("nilai-greet")
