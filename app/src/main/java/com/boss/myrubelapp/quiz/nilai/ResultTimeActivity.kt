...
import kotlinx.android.synthetic.main.activity_result_time.*

class ResultTimeActivity : AppCompatActivity() {
    companion object {
        val TAG = "Result Time"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val quizName = intent.getStringExtra(ConstTime.QUIZ_NAME)
        val correctAnswers = intent.getIntExtra(ConstTime.CORRECT_ANSWERS, 0) * 10
    ...
    private fun inputNilai() {
        ...
        val ref = FirebaseDatabase.getInstance().getReference("nilai-time/$uid")
    ...
    private fun fetchData() {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                Log.d(TAG, "nilai time ${currentUser?.username}")
